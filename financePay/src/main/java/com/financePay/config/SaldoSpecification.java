...
public class SaldoSpecification {
    ...
    public static Specification<Saldo> saldoMin(Double saldoMin) {
        return (root, query, criteriaBuilder) -> criteriaBuilder.greaterThanOrEqualTo(root.get("saldo"), saldoMin);
    }

    public static Specification<Saldo> saldoMax(Double saldoMax) {
        return (root, query, criteriaBuilder) -> criteriaBuilder.lessThanOrEqualTo(root.get("saldo"), saldoMax);
    }
}